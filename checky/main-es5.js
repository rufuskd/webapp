...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppSettingsSettingsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<a [routerLink]=\"['/create-task']\">\n<h1> This is a page that shows settings. </h1>\n</a>\n";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTaskEntryTaskEntryComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTaskTableTaskTableComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppViewTasksViewTasksComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _task_entry_task_entry_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./task-entry/task-entry.component */
    ...
    var _view_tasks_view_tasks_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./view-tasks/view-tasks.component */
    ...
    var _task_table_task_table_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    var appRoutes = [{
      path: 'create-task',
      component: _task_entry_task_entry_component__WEBPACK_IMPORTED_MODULE_5__["TaskEntryComponent"]
    }, {
      path: 'xview-tasks',
      component: _view_tasks_view_tasks_component__WEBPACK_IMPORTED_MODULE_7__["ViewTasksComponent"]
    }, {
      path: 'settings',
      component: _settings_settings_component__WEBPACK_IMPORTED_MODULE_8__["SettingsComponent"]
    }, {
      path: 'view-tasks',
      component: _task_table_task_table_component__WEBPACK_IMPORTED_MODULE_11__["TaskTableComponent"]
    }, {
      path: '**',
      component: _settings_settings_component__WEBPACK_IMPORTED_MODULE_8__["SettingsComponent"]
    }];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _task_entry_task_entry_component__WEBPACK_IMPORTED_MODULE_5__["TaskEntryComponent"], _view_tasks_view_tasks_component__WEBPACK_IMPORTED_MODULE_7__["ViewTasksComponent"], _settings_settings_component__WEBPACK_IMPORTED_MODULE_8__["SettingsComponent"], _task_table_task_table_component__WEBPACK_IMPORTED_MODULE_11__["TaskTableComponent"]],
      imports: [_angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot(appRoutes), _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_10__["BrowserAnimationsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_12__["MatTableModule"]],
      providers: [],
  ...
  /***/
  function srcAppTaskEntryTaskEntryComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTaskEntryTaskEntryComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TaskEntryComponent", function () {
    ...
    var _tasklist_tasklist_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function TaskEntryComponent(taskListService) {
        _classCallCheck(this, TaskEntryComponent);
      ...
      _createClass(TaskEntryComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        key: "taskClick",
        value: function taskClick() {
          var newTask = {
            name: this.taskForm.value.taskName,
            requirements: []
          };
          this.taskForm.controls.requirements.controls.forEach(function (t) {
            var temp = {
              name: t.controls.reqName.value,
              quantity: t.controls.reqQuantity.value
            };
    ...
    TaskEntryComponent.ctorParameters = function () {
      return [{
        type: _tasklist_tasklist_service__WEBPACK_IMPORTED_MODULE_3__["TaskListService"]
      }];
    };

    TaskEntryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-task-entry',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./task-entry.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/task-entry/task-entry.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./task-entry.component.css */
      "./src/app/task-entry/task-entry.component.css")).default]
    })], TaskEntryComponent);

    var RequirementFormGroup =
    /*#__PURE__*/
    function (_angular_forms__WEBPA) {
      _inherits(RequirementFormGroup, _angular_forms__WEBPA);

      function RequirementFormGroup(rn, rq) {
        _classCallCheck(this, RequirementFormGroup);

        return _possibleConstructorReturn(this, _getPrototypeOf(RequirementFormGroup).call(this, {
          reqName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](rn),
          reqQuantity: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](rq)
        }));
      }

      return RequirementFormGroup;
  ...
  /***/
  function srcAppTaskTableTaskTableComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTaskTableTaskTableComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _tasklist_tasklist_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../tasklist/tasklist.service */
    "./src/app/tasklist/tasklist.service.ts");
    /**
    ...
    /*#__PURE__*/
    function () {
      function TaskTableComponent(taskListService) {
        var _this = this;
        ...
        this.expandedTask = [];
        this.taskListService.getTasks().subscribe(function (data) {
          _this.taskArray = data.body;
          console.warn(data);
        }, function (error) {
          return console.warn("Failed to populate task table");
        });
      }

      _createClass(TaskTableComponent, [{
        key: "handleDeleteTaskClick",
        value: function handleDeleteTaskClick(t) {
          console.warn("Tried to delete");
          var killindex = this.taskArray.indexOf(t, 0);

          if (killindex > -1) {
            this.taskArray.splice(killindex, 1);
          }

          this.taskListService.removeFromTaskList(t).subscribe(function (data) {
            console.warn(data);
          }, function (error) {
            return console.warn("Failed to delete shit");
          });
          this.table.renderRows();
        }
      }, {
        key: "handleExpandedItemClick",
        value: function handleExpandedItemClick() {
          console.warn("ASSY THE BUTT DOG!");
        }
      }, {
        key: "handleTaskClick",
        value: function handleTaskClick(t) {
          var killindex = this.expandedTask.indexOf(t, 0);
    ...
    TaskTableComponent.ctorParameters = function () {
      return [{
    ...
    TaskTableComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-task-table',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./task-table.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/task-table/task-table.component.html")).default,
      animations: [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["trigger"])('detailExpand', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["state"])('collapsed', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["style"])({
        height: '0px',
        minHeight: '0'
      ...
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./task-table.component.css */
      "./src/app/task-table/task-table.component.css")).default]
    })], TaskTableComponent);
    /***/
  },
  ...
  /***/
  function srcAppTasklistTasklistServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      function TaskListService(httpClient) {
    ...
    TaskListService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }) //Change this from just storing it's own shit
    //to connecting to a wsgi to pass in JSON
    ], TaskListService);
  ...
  /***/
  function srcAppViewTasksViewTasksComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewTasksViewTasksComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewTasksComponent", function () {
    ...
    var ViewTasksComponent =
    /*#__PURE__*/
    function () {
      function ViewTasksComponent(taskListService) {
        var _this2 = this;

        _classCallCheck(this, ViewTasksComponent);

        this.taskListService = taskListService;
        this.taskName = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('');
        this.tasks = [];
        this.taskListService.getTasks().subscribe(function (data) {
          console.warn(data), _this2.tasks = data.body;
        }, function (error) {
          return console.warn("BALLS");
      ...
      _createClass(ViewTasksComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    ViewTasksComponent.ctorParameters = function () {
      return [{
        type: _tasklist_tasklist_service__WEBPACK_IMPORTED_MODULE_3__["TaskListService"]
      }];
    };

    ViewTasksComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-view-tasks',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./view-tasks.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/view-tasks/view-tasks.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./view-tasks.component.css */
      "./src/app/view-tasks/view-tasks.component.css")).default]
    })], ViewTasksComponent);
    /***/
  },
